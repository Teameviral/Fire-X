...
@fire.on(fire_on_cmd(outgoing=True, pattern="magisk$"))
@fire.on(sudo_cmd(pattern="magisk$", allow_sudo=True))
...
@fire.on(fire_on_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@fire.on(sudo_cmd(pattern="device(?: |$)(\S*)", allow_sudo=True))
...
@fire.on(fire_on_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@fire.on(sudo_cmd(pattern="specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@fire.on(fire_on_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@fire.on(sudo_cmd(pattern="twrp(?: |$)(\S*)", allow_sudo=True))
