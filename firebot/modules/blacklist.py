...
@fire.on(events.NewMessage(incoming=True))
...
@fire.on(fire_on_cmd("textblacklist ((.|\n)*)"))
@fire.on(sudo_cmd("textblacklist ((.|\n)*)", allow_sudo=True))
...
@fire.on(fire_on_cmd("listblacklist"))
@fire.on(sudo_cmd("listblacklist", allow_sudo=True))
...
@fire.on(fire_on_cmd("rmblacklist ((.|\n)*)"))
@fire.on(sudo_cmd("rmblacklist ((.|\n)*)", allow_sudo=True))
