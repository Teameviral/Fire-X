...
#Import Gudz
RUN wget https://raw.githubusercontent.com/FireXbot/firexuserbot/master/firebotmain.py
RUN wget https://raw.githubusercontent.com/FireXbot/firexuserbot/master/requirements.txt
#Start Fumkin
