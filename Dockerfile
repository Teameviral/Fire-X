...
#Import Gudz
RUN wget https://raw.githubusercontent.com/TeamEviral/firexuserbot/master/firebotmain.py
RUN wget https://raw.githubusercontent.com/TeamEviral/firexuserbot/master/requirements.txt
#Start Fumkin
