...
#Import Gudz
RUN wget https://raw.githubusercontent.com/FireXbot/Fire-X/master/firebotmain.py
RUN wget https://raw.githubusercontent.com/FireXbot/Fire-X/master/requirements.txt
#Start Fumkin
